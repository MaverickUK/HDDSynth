...
try:
    ...
    target_mode = nvm_wrapper.MODE_USB    

if target_mode not in (nvm_wrapper.MODE_USB, nvm_wrapper.MODE_WRITE):
...
if not safety_pin.value:
    ...
    microcontroller.nvm[settings.NVM_ADDRESS_MODE] = nvm_wrapper.MODE_USB # Reset flag
    
elif target_mode == nvm_wrapper.MODE_WRITE:
